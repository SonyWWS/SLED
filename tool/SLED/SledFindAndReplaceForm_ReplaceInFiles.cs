...
namespace Sce.Sled
{
    partial class SledFindAndReplaceForm_ReplaceInFiles : UserControl, ISledFindAndReplaceSubForm
    {
        public SledFindAndReplaceForm_ReplaceInFiles()
        {
            InitializeComponent();
            ...
            m_chkIncludeSubFolders.Checked = SledFindAndReplaceSettings.ReplaceInFiles.IncludeSubFolders;
            if (m_cmbLookIn.Items.Count > 0)
            {
                if ((SledFindAndReplaceSettings.ReplaceInFiles.LookInIndex >= 0) &&
                    (SledFindAndReplaceSettings.ReplaceInFiles.LookInIndex < m_cmbLookIn.Items.Count))
                    m_cmbLookIn.SelectedIndex = SledFindAndReplaceSettings.ReplaceInFiles.LookInIndex;
                else
                    m_cmbLookIn.SelectedItem = m_cmbLookIn.Items[0];
            }
            m_chkMatchCase.Checked = SledFindAndReplaceSettings.ReplaceInFiles.MatchCaseChecked;
            m_chkMatchWholeWord.Checked = SledFindAndReplaceSettings.ReplaceInFiles.MatchWholeWordChecked;
            m_chkUse.Checked = SledFindAndReplaceSettings.ReplaceInFiles.UseChecked;
            if (m_cmbUse.Items.Count > 0)
            {
                if ((SledFindAndReplaceSettings.ReplaceInFiles.UseIndex >= 0) &&
                    (SledFindAndReplaceSettings.ReplaceInFiles.UseIndex < m_cmbUse.Items.Count))
                    m_cmbUse.SelectedIndex = SledFindAndReplaceSettings.ReplaceInFiles.UseIndex;
                else
                    m_cmbUse.SelectedItem = m_cmbUse.Items[0];
            }
            if (SledFindAndReplaceSettings.ReplaceInFiles.Results1WindowChecked)
            {
            ...
            m_chkDisplayFileNamesOnly.Checked = SledFindAndReplaceSettings.ReplaceInFiles.DisplayFileNamesOnlyChecked;
            m_chkKeepModifiedFilesOpenAfterReplaceAll.Checked = SledFindAndReplaceSettings.ReplaceInFiles.KeepModifiedFilesOpen;
        ...
        private void SledFindAndReplaceFormReplaceInFilesLoad(object sender, EventArgs e)
        {
            if (!SledFindAndReplaceSettings.ReplaceInFiles.FindOptionsExpanded)
                m_grpFindOptions.Collapse();

            if (!SledFindAndReplaceSettings.ReplaceInFiles.ResultOptionsExpanded)
        ...
        private void CollapsedOrExpanded(object sender, int iPlusOrMinus)
        {
            ...
            if (grpBox == m_grpFindOptions)
            {
                ...
                SledFindAndReplaceSettings.ReplaceInFiles.FindOptionsExpanded = (iPlusOrMinus > 0);
            }
            else if (grpBox == m_grpResultOptions)
            {
                SledFindAndReplaceSettings.ReplaceInFiles.ResultOptionsExpanded = (iPlusOrMinus > 0);
            }
        ...
        private void BtnSkipFileClick(object sender, EventArgs e)
        {
        }
        ...
        private void BtnReplaceAllClick(object sender, EventArgs e)
        {
            ...
            var ea = new SledFindAndReplaceEventArgs.ReplaceInFiles(
                ...
                m_chkMatchWholeWord.Checked,
                searchType,
                m_rdoFindResults1Window.Checked ? SledFindAndReplaceResultsWindow.One : SledFindAndReplaceResultsWindow.Two,
                m_chkKeepModifiedFilesOpenAfterReplaceAll.Checked);
        ...
        private void CmbLookInSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SledFindAndReplaceSettings.ReplaceInFiles.LookInIndex = iSelectedIndex;
            ...
            if (iSelectedIndex == m_iCmbLookInCustomIdx)
            {
                ...
                if (form.ShowDialog(this) == DialogResult.OK)
                {
                    ...
                    SledFindAndReplaceSettings.ReplaceInFiles.LookInIndex = 0;
        ...
        {
            SledFindAndReplaceSettings.ReplaceInFiles.IncludeSubFolders = ((CheckBox)sender).Checked;
        }

        private void ChkMatchCaseCheckedChanged(object sender, EventArgs e)
        {
            SledFindAndReplaceSettings.ReplaceInFiles.MatchCaseChecked = ((CheckBox)sender).Checked;
        }

        private void ChkMatchWholeWordCheckedChanged(object sender, EventArgs e)
        {
            SledFindAndReplaceSettings.ReplaceInFiles.MatchWholeWordChecked = ((CheckBox)sender).Checked;
        }

        private void ChkUseCheckedChanged(object sender, EventArgs e)
        {
            m_cmbUse.Enabled = ((CheckBox)sender).Checked;
            SledFindAndReplaceSettings.ReplaceInFiles.UseChecked = ((CheckBox)sender).Checked;
        }

        private void CmbUseSelectedIndexChanged(object sender, EventArgs e)
        {
            SledFindAndReplaceSettings.ReplaceInFiles.UseIndex = ((ComboBox)sender).SelectedIndex;
        }

        private void RdoFindResults1WindowCheckedChanged(object sender, EventArgs e)
        {
            SledFindAndReplaceSettings.ReplaceInFiles.Results1WindowChecked = m_rdoFindResults1Window.Checked;
        }

        private void ChkDisplayFileNamesOnlyCheckedChanged(object sender, EventArgs e)
        {
            SledFindAndReplaceSettings.ReplaceInFiles.DisplayFileNamesOnlyChecked = ((CheckBox)sender).Checked;
        }

        private void ChkKeepModifiedFilesOpenAfterReplaceAllCheckedChanged(object sender, EventArgs e)
        {
            SledFindAndReplaceSettings.ReplaceInFiles.KeepModifiedFilesOpen = ((CheckBox)sender).Checked;
        }
